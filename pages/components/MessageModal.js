...
const MessageModal = ({ show, onClose, name, location, message }) => {
	...
	return (
		<div
			className={classNames("absolute flex top-8 left-8 w-full h-full", {
				'invisible': !show
			})}
		>
			<div
				className="z-10 relative bg-white m-auto content-center w-10/12 p-10 px-28 border-solid border-2 border-gray-300 rounded-3xl overflow-y-auto"
			>
				<button
