...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.container.style6 > .wrapper > .inner', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-right', speed: 750, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-left', speed: 750, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-in', speed: 750, intensity: 5, delay: 0, replay: false });
		onvisible.add('.buttons.style3', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-left', speed: 750, intensity: 1, delay: 0, replay: false });
		onvisible.add('hr.style1', { style: 'fade-in', speed: 750, intensity: 5, delay: 0, replay: false });
		onvisible.add('.image.style2', { style: 'zoom-in', speed: 750, intensity: 1, delay: 0, replay: false });
		onvisible.add('.container.style5', { style: 'fade-up', speed: 750, intensity: 1, delay: 0, replay: false });
		onvisible.add('hr.style2', { style: 'fade-in', speed: 750, intensity: 5, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-up', speed: 500, intensity: 1, delay: 0, stagger: 125, replay: false });
